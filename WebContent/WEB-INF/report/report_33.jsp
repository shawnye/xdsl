...
<fieldset>
	<legend>NGN设备统计 <span id="countDisplay" style="color:red;"></span> </legend><%-- 修改标题 --%>
	...
	<form action="${ctx }/report?@id=${report.id}" id="reportForm" method="post" accept-charset="utf-8">
		...
		<table id="cond_table">	<%-- BEGIN 修改条件 --%>
			<tr>
				...
				<td><input type="text" name="sbmc" value="${ sbmc }" width="10" ></td>
				<td class="label">机房：</td>
				<td><input type="text" name="jfmc" value="${ jfmc }" width="10"></td>
			  
			</tr>
			<%-- sql语句中没有此属性
			<tr>
			  <td class="label">是否反极：</td>
			  <td><input type="text" name="jixing=" value="${ jixing }"  title="精确匹配">(yes?)</td>
			   <td>	&nbsp;</td>
			  <td>	&nbsp;</td>
			  <td>	&nbsp;</td>
			  <td>	&nbsp;</td>
