...
<fieldset>
 ...
 <tr>
	...
	<td><input type="text" name="page_limit" value="${ page_limit }" width="30"></td>
	<td class="label">产品号码：</td>
	<td><input type="text" name="p_num" value="${ p_num }" width="30"></td>
	<td class="label">客户名称：</td>
	<td><input type="text" name="u_name" value="${ u_name }" width="30"></td>
	<td class="label">状态：</td>
	<td><input type="text" name="state" value="${ state }" width="30" title="正常/测试"></td>
</tr>
<tr>
	<td class="label">用户性质：</td>
	<td><input type="text" name="u_type" value="${ u_type }" width="30"></td>
	<td class="label">业务类型：</td>
	<td><input type="text" name="s_type" value="${ s_type }" width="30"></td>
	<td class="label">用户装机地址：</td>
	<td><input type="text" name="u_address" value="${ u_address }" width="30"></td>
	<td class="label">用户ip地址：</td>
	<td><input type="text" name="u_ip" value="${ u_ip }" width="30"></td>
</tr>
<tr>
	<td class="label">网关：</td>
	<td><input type="text" name="u_gateway" value="${ u_gateway }" width="30"></td>
	<td class="label">联系人：</td>
	<td><input type="text" name="contact" value="${ contact }" width="30"></td>
	<td class="label">联系电话：</td>
	<td><input type="text" name="tel" value="${ tel }" width="30"></td>
	<td class="label">接入机房：</td>
	<td><input type="text" name="jifang" value="${ jifang }" width="30"></td>
</tr>
<tr>
	<td class="label">接入设备名称：</td>
	<td><input type="text" name="d_name" value="${ d_name }" width="30"></td>
	<td class="label">接入设备ip地址：</td>
	<td><input type="text" name="d_ip" value="${ d_ip }" width="30"></td>
	<td class="label">网关设备：</td>
	<td><input type="text" name="g_dev" value="${ g_dev }" width="30"></td>
	<td class="label">&nbsp;</td>
	<td>&nbsp;</td>
	
</tr>
<tr>
	<td class="label">用户带宽&gt;=：</td>
	<td><input type="text" name="bandwidth&gt;=" value="${ bandwidth_start }" width="30"></td>
	<td class="label">用户带宽&lt;=：</td>
	<td><input type="text" name="bandwidth&lt;=" value="${ bandwidth_end }" width="30"></td>
	<td class="label">开通时间&gt;=：</td>
	<td><input type="text" name="begin_date&gt;=" value="${ begin_date_start }" id="begin_date_start" width="30"></td>
	<td class="label">开通时间&lt;=：</td>
	<td><input type="text" name="begin_date&lt;=" value="${ begin_date_end }" id="begin_date_end" width="30"></td>
</tr>
...
function isDisabled(date) {
	return date.valueOf() > new Date().valueOf()+ 60000;
}
