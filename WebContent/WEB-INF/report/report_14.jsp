...
//			var params=$(':text').serialize();
		...
		$('#new_sbh_help').click(function(){
			setValue(this.id,'new_sbh');
		});
		$('#old_sbh_help').click(function(){
			setValue(this.id,'old_sbh');
		});
...
<tr> 
	<td class="label">原机房：</td>
	<td><input type="text" name="old_jx" value="${ old_jx }" size="10" id="old_jx"><input type="checkbox" id="old_jx_exact" >精确查询</td> 
	<td class="label">原设备号：</td>
	<td><input type="text" name="old_sbh" id="old_sbh"  value="${ old_sbh }"  size="10"  title="模糊查询">
	<select id="old_sbh_help">
		...
		</select><input type="checkbox" id="old_sbh_exact" >精确查询
	</td> 
	<td class="label">原MDF端口：</td>
	<td><input type="text" name="old_mdf_port" value="${ old_mdf_port }" size="10" id="old_mdf_port"><input type="checkbox" id="old_mdf_port_exact" >精确查询</td> 
	
</tr>
<tr> 
	<td class="label">新机房：</td>
	<td><input type="text" name="new_jx" value="${ new_jx }" size="10" id="new_jx"><input type="checkbox" id="new_jx_exact" >精确查询</td> 
	<td class="label">新设备号：</td>
	<td><input type="text" name="new_sbh" id="new_sbh"  value="${ new_sbh }"  size="10"  title="模糊查询">
	<select id="new_sbh_help">
			<option value="">[请选择]</option>
			<option value="7302FD">7302FD</option>
			<option value="9806H">9806H</option>
		...
		</select><input type="checkbox" id="new_sbh_exact" >精确查询
	</td> 
	<td class="label">新MDF端口：</td>
