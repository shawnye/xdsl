...
<fieldset>
	<legend>AD端口查询(监控专用) <span id="countDisplay" style="color:red;"></span> </legend><%-- 修改标题 --%>
	...
	<form action="${ctx }/report?@id=${report.id}" id="reportForm" method="post" accept-charset="utf-8">
		...
		<table id="cond_table">	<%-- BEGIN 修改条件 --%>
			...
			<td class="label">机房：</td>
				<td><input type="text" name="jx" id="jx" value="${ jx }" size="10"  title="请从机房名称表选择"><input type="checkbox" id="jx_exact" >精确查询
				<br/><a href="${ctx }/report?@id=4&page_limit=200" target="_blank">机房名称表 </a>
				</td>
			<td class="label">设备名称：</td>
				<td><input type="text" name="sbh" value="${ sbh }" id="sbh" size="10" ><input type="checkbox" id="sbh_exact" >精确查询</td>
