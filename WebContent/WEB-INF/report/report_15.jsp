...
<tr> 
	...
	<td><input type="text" name="p_id" id="p_id" value="${ p_id }" size="10" ></td>
	<td class="label">用户名</td>
	<td><input type="text" name="username" id="username" value="${ username }" size="10" ></td>
