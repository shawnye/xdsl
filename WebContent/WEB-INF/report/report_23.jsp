...
<fieldset>
	<legend>机房端口导入更新专用查询 <span id="countDisplay" style="color:red;"></span> </legend><%-- 修改标题 --%>
		...
		<table id="cond_table">	<%-- BEGIN 修改条件 --%>
			...
			<td class="label">机房：</td>
				<td><input type="text" name="jx" id="jx" value="${ jx }" size="10" >
					<input type="checkbox" id="jx_exact" >精确查询
				</td>
	...
	<tr>
		...
		<select id="type_help">
			...
			<c:forTokens items="AD,PON-AD,PON-LAN,LAN,WLAN,FTTH" delims="," var="i">
			 ...
			 <td> <input type="text" name="j0.batch_num" id="batch_num" value="${ batch_num }" width="35" />
		 	</td>
			</tr>	
