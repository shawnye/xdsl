...
/**
 * Servlet implementation class ZytjExportServlet
 */
public class ZytjExportServlet extends BaseServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ZytjExportServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String ext = "csv";
		String downloadFileName = "语音端口信息" + DateFormatUtils.format(new Date(), "yyyyMMdd_HHmmss") + "." + ext ;
...
//				request.setAttribute(searchCondition.getEchoField(name), value);//回显
		...
		try {
			zytjService.exportFile(destFile, exportConfig );
