...
/**
 * Servlet implementation class JxInfoExportServlet
 */
public class JxInfoExportServlet extends BaseServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public JxInfoExportServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String ext = "csv";
		String downloadFileName = "机房信息" + DateFormatUtils.format(new Date(), "yyyyMMdd_HHmmss") + "." + ext ;
...
//				request.setAttribute(searchCondition.getEchoField(name), value);//回显
		...
		try {
			jxInfoService.exportFile(destFile, exportConfig );
